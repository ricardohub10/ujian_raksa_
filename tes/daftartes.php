...
<div class="block full">
    ...
    <div class="block-title">
        <div class="block-options pull-right">
            Siswa Waktu <a href="javascript:void(0)" class="btn btn-sm btn-alt btn-default"><div id='timer'></div>
...
<!-- 
            ...
            <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
            150%'><span style='font-family:"MS Mincho"'>
            <input name="pilihan[]" <?php if($data['jawaban'] == "f"){echo "checked"; }?> value="f" type="radio"></span></p></td>   
            <td width=554 valign=top style='width:415.25pt;padding:0cm 5.4pt 0cm 5.4pt'>
            <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
            150%'><span style='font-family:"Times New Roman","serif"'><?php echo $data['pilihanf'];?></span></p>
            </td> 
        <tr> -->
...
<?php }?>
            ...
            ?>
                    <a onclick="$('#modal-user-settingsx').modal('show');" title="Delete" class="btn btn-success">Lihat Jawaban Saya</a>
                    </form>
                    <div class="modal fade" id="modal-user-settingsx" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <!-- Kodingan ini ditambah oleh Ricardo 13 Juni 2022 -->
                                <!-- <input type="hidden" name="statusujian" value="sudah"> -->

                                <table class="table table-bordered table-striped" width="100%">
                                <tr>
                                    <td>No</td>
                                    <td>Soal dan Jawaban</td>
                                    <td>Edit</td>
                                </tr>
                                <?php 
                                        $no = 1;
                                        ...
                                        <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><?php echo $jawaban['soal']; ?>
                                            <br>
                                            <br>
                                            <strong>JAWABAN: <?php echo $jawaban['jawaban'];?></strong>
                                        </td>
                                        <td><a href="http://localhost/ujian_raksa_/index.php?tes=<?php echo $no-$x; ?>">Edit Jawaban<a></td>
                                        </tr>
                                        <?php
                                        }
                                        ?>
