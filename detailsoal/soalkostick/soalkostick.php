...
?>
<a href="index.php?tambahsoalkostick&idgroup=<?php echo $idgroup; ?>" title="Tambah Soal" class="btn btn-sm btn-info">Tambah</a>
...
<?php } ?>
                <a href="detailsoal/eksportexcel.php?idgroup=<?php echo $idgroup; ?>&jenissoal=kostickanswer" title="Export Soal" class="btn btn-sm btn-success">Export Ke Excel</a>
            ...
            <div class="table-responsive">
                <table id="example-datatable" class="soalpilihanganda table table-striped">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $tampil = mysqli_query($mysqli, "select * from soal where jenissoal='kostickanswer' and idgroup='$idgroup' ");
                        while ($hasil = mysqli_fetch_array($tampil)) {
                            ...
                            <tr>
                                ...
                                <?php if($_SESSION['iduser']==$d['iduser']){?>
                                    ...
                                    <a title="Edit" href="index.php?editsoalkostick&idgroup=<?php echo $idgroup; ?>&idsoal=<?php echo $hasil['idsoal']; ?>" class="btn btn-sm btn-info"><i class="fa fa-edit"></i></a>
                                    <a title="Delete" onclick="return confirm('apakah anda yakin ingin menghapus data? ');" href="detailsoal/soalkostick/proseshapus.php?idsoal=<?php echo $hasil['idsoal']; ?>&idgroup=<?php echo $hasil['idgroup']; ?>" title="Delete" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a
                                </td>
                                <?php }else{?>
                                    <td class="text-center">
