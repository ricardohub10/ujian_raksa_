...
?>
 <a href="index.php?tambahsoalmultipleanswer&idgroup=<?php echo $idgroup; ?>" class="btn btn-sm btn-info">Tambah</a>           
 <button type="reset" class="btn btn-sm btn-success" onclick="$('#modal-import-soalmultipleanswer').modal('show');">Import dari Excel</button>
                <div class="modal fade" id="modal-import-soalmultipleanswer" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="hidden" value="multipleanswer" name="jenissoal">
...
<?php } ?>
            <a href="detailsoal/eksportexcel.php?idgroup=<?php echo $idgroup; ?>&jenissoal=multipleanswer" class="btn btn-sm btn-success">Export Ke Excel</a>
            <br>
            <br>
<div class="table-responsive">
    <table id="example-datatable" class="table table-striped">
        ...
        <tbody>
            <?php
            $no = 1;
            $tampil = mysqli_query($mysqli, "select * from soal where jenissoal='multipleanswer' and idgroup=$idgroup");
...
<script src="js/pages/datatablesoalmultipleanswer.js"></script>
